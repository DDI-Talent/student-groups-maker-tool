...
# source('./pairs_engine/generations.R')
...
# pairMaker <- PairMaker$new()
# new_history_for_class <- pairMaker$innitialise_class(c("a","b","c"))
# pairMaker$load_history_from_file("efi_text_history2.csv")
# # pairMaker$history
# all_potential_attendees <- pairMaker$get_all_potential_attendees()
# # all_potential_attendees
# new_history_for_class <- pairMaker$innitialise_class(c("a","b","c"))
# new_history <- pairMaker$make_pairs_for_session(all_potential_attendees, "testing1")
# pairMaker$approve_new_history(new_history)
# pairMaker$save_history_to_file()
